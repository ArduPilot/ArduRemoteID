...
static const enum_map_t enum_sacc[] = {
    { ODID_SPEED_ACC_UNKNOWN , "ACC_UNKNOWN" },
    { ODID_SPEED_ACC_10_METERS_PER_SECOND , "ACC_10_METERS_PER_SECOND" },
    { ODID_SPEED_ACC_3_METERS_PER_SECOND , "ACC_3_METERS_PER_SECOND" },
    { ODID_SPEED_ACC_1_METERS_PER_SECOND , "ACC_1_METERS_PER_SECOND" },
    { ODID_SPEED_ACC_0_3_METERS_PER_SECOND , "ACC_0_3_METERS_PER_SECOND" },
};
